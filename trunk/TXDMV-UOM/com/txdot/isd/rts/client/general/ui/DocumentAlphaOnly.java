 ...
 * B Hargrove	08/18/2005	Java 1.4 code cleanyup.
 ...
 */
/**
 * Allows only Alphabet characters
 * 
 * @version	5.2.3		08/18/2005
 * @author	Michael Abernethy
 * <br>Creation Date:	09/05/2001 11:04:36
 */
public class DocumentAlphaOnly extends AbstractDocument
{
	/**
	 * Creates a DocumentAlphaOnly.
	 * 
	 * @param aiMaxLength int
	 */
	public DocumentAlphaOnly(int aiMaxLength)
	{
		super();
