 ...
 */
/**
 * Allows only numerals to be typed
 * 
 * @version	5.2.3		08/18/2005
 * @author	Michael Abernethy
 * <br>Creation Date:	09/05/2001 11:04:36
 */
public class DocumentNumericOnly extends AbstractDocument
{
	/**
	 * Creates a DocumentNumericOnly.
	 * 
	 * @param aiMaxLength int
	 */
	public DocumentNumericOnly(int aiMaxLength)
	{
		super();
