 ...
 * B Hargrove	08/18/2005	Java 1.4 code cleanup.
 * 							Format comments, Hungarian notation, etc. 
 * 							defect 7885 Ver 5.2.3 
 * ---------------------------------------------------------------------
 */
/**
 * Allows only Alphanumeric characters to be entered with no space
 * 
 * @version	5.2.3		08/18/2005
 * @author	Michael Abernethy
 * <br>Creation Date:	09/05/2001 11:04:36
 */
public class DocumentAlphaNoSpace extends AbstractDocument
{
	/**
 	* Creates a DocumentAlphaNoSpace Document.
 	*/
	public DocumentAlphaNoSpace(int aiMaxLength) 
	{
		super();
	 ...
	 */
	public void insertString(int aiOffs, String asStr, AttributeSet aaAttr) 
		throws javax.swing.text.BadLocationException
	{
		...
		for (int i=0; i<lsTemp.length(); i++)
		{
			...
			{
				super.insertString(liTempOffs, new String("" + lchChar),
					 aaAttr);
				liTempOffs++;
			}
