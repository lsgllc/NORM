...
/**
 * Table model for screen FUN015.  Sets the column count and names
 ...
 */
public class TMFUN015 extends javax.swing.table.AbstractTableModel
{
	...
	public Object getValueAt(int aiRow, int aiCol)
	{
		// defect 9943 
		//if (aiCol == 0)
		if (aiCol == FundsConstant.FUN015_CASH_DRAWER)
		{
			return new Integer(
		...
		//else if (aiCol == 1)
		else if (aiCol == FundsConstant.FUN015_STATUS)
		{
			return (String)
				((CashWorkstationCloseOutData) cvVector.get(aiRow))
				.getRptStatus();
