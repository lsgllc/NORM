...
public class TMFUN013b extends javax.swing.table.AbstractTableModel
{
	private Vector cvVector;

	private final static String[] carrColumn_Name =
		{ "Cash Drawer", "Report Status" };

	/**
	 * TMFUN013b constructor 
	 */
	public TMFUN013b()
	{
		super();
	...
	public Object getValueAt(int aiRow, int aiCol)
	{
		...
		{
			return new Integer(
				((EntityStatusData) cvVector.get(aiRow)).getCashWsId());
