...
/*
 *
 * VCSecurityRightsAccountingSEC014.java
 *
...
/**
 * Controller for Security Rights Accounting screen SEC014 
 * 
 * @version	5.2.3		04/16/2005
 * @author 	Administrator
 * <br>Creation Date:	08/13/2001 15:17:43 	  
 */

public class VCSecurityRightsAccountingSEC014
	extends AbstractViewController
{
	/**
	 * VCSecurityRightsAccountingSEC014 constructor comment.
	 */
	public VCSecurityRightsAccountingSEC014()
	{
		super();
	}
	/**
...
// end defect 7891
		...
		Object aaData)
	{
		if (getFrame() == null)
		{
			...
			{
				setFrame(
					new FrmSecurityAccessRightsAccountingSEC014(laRTSDB));
			}
			else
			{
				setFrame(
