...
/*
 *
 * VCSecurityAccessRightsMiscRegSEC010.java
 *
...
/**
 * Controller for Security Access Rights Misc Reg screen SEC010 
 * 
 * @version	5.2.3		04/16/2005
 * @author 	Administrator
 * <br>Creation Date:	08/13/2001 15:21:30 	  
 */
public class VCSecurityAccessRightsMiscRegSEC010
	extends AbstractViewController
{
	/**
	 * VCSecurityAccessRightsMiscRegSEC010 constructor comment.
	 */
	public VCSecurityAccessRightsMiscRegSEC010()
	{
		super();
	}
	/**
...
// end defect 7891
	 ...
	 * 
	 * @param previousControllers vector  
		...
		Object aaData)
	{
		if (getFrame() == null)
		{
			...
			{
				setFrame(
					new FrmSecurityAccessRightsMiscRegSEC010(laDialog));
			}
			else
			{
				setFrame(
