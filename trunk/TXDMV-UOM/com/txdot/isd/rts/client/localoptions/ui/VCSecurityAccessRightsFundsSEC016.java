...
/*
 *
 * VCSecurityAccessRightsFundsSEC016.java
 *
...
/**
 * Controller for SEC016 screen 
 * 
 * @version	5.2.3		04/16/2005
 * @author 	Administrator
 * <br>Creation Date:	08/13/2001 15:18:31 	  
 */

public class VCSecurityAccessRightsFundsSEC016
	extends AbstractViewController
{
	/**
	 * VCSecurityAccessRightsFundsSEC016 constructor comment.
	 */
	public VCSecurityAccessRightsFundsSEC016()
	{
		super();
	}
	/**
...
// end defect 7891
	/**
	 * Handles data coming from their JDialogBox - inside the subclasses i
	 * mplementation should be calls to fireRTSEvent() to pass the data 
	 * to the RTSMediator.
	 * 
	 * @param aiCommand int  
	 * @param aaData Object 
		...
		Object aaData)
	{
		if (getFrame() == null)
		{
			...
			{
				setFrame(
					new FrmSecurityAccessRightsFundsSEC016(laDialog));
			}
			else
			{
				setFrame(
