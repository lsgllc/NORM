...
/*
 * VCRenewDisabledPlacardMRG028.java
 * 
...
/**
 * View controller for FrmRenewDisabledPlacardMRG028
 *
 * @version 6.10.0	01/12/2012
 * @author Kathy Harrell
 * @since 			01/12/2012 17:12:17
 */
public class VCRenewDisabledPlacardMRG028 extends
		AbstractViewController
{
	public final static int REDIRECT = 30;

	/**
	 * VCRenewDisabledPlacardMRG028 default constructor.
	 */
	public VCRenewDisabledPlacardMRG028()
	{
		super();
	}
			...
			String asTransCode, Object aaData)
	{
		...
		if (getFrame() == null)
		{
			...
			if (laRTSDialogBox != null)
			{
				...
				setFrame(new FrmRenewDisabledPlacardMRG028(
						laRTSDialogBox));
			}
			else
			{
