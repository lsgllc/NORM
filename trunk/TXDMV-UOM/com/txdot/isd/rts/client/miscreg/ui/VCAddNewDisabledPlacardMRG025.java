...
/*
 * VCAddNewDisabledPlacardMRG025.java
 *
...
/**
 * View Controller for FrmAddNewDisabledPlacardMRG025 
 *
...
public class VCAddNewDisabledPlacardMRG025 extends AbstractViewController
{
	public final static int REDIRECT = 30;

	/**
	 * VCAddNewDisabledPlacardMRG025 default constructor.
	 */
	public VCAddNewDisabledPlacardMRG025()
	{
		super();
	}
		...
		Object aaData)
	{
		...
		if (getFrame() == null)
		{
			...
			if (laRTSDialogBox != null)
			{
				...
				setFrame(new FrmAddNewDisabledPlacardMRG025(laRTSDialogBox));
			}
			else
			{
				setFrame(
					new FrmAddNewDisabledPlacardMRG025(
