...
/*
 * VCReplaceDisabledPlacardMRG026.java
 *
...
/**
 * View Controller for Replace Disabled Placard. 
 *
 * @version Defect_POS_B 	10/27/2008
 * @author	Kathy Harrell
 * <br>Creation Date:		10/27/2008 
 */
public class VCReplaceDisabledPlacardMRG026
	extends AbstractViewController
{
	public final static int REDIRECT = 30;

	/**
	* VCReplaceDisabledPlacardMRG026 default constructor.
	*/
	public VCReplaceDisabledPlacardMRG026()
	{
		super();
	}
		...
		Object aaData)
	{
		...
		if (getFrame() == null)
		{
			...
			if (laRTSDialogBox != null)
			{
				...
				setFrame(
					new FrmReplaceDisabledPlacardMRG026(laRTSDialogBox));
			}
			else
			{
				setFrame(
					new FrmReplaceDisabledPlacardMRG026(
