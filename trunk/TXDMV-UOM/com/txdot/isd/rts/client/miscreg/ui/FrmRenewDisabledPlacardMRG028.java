...
/*
 * FrmRenewDisabledPlacardMRG028.java
 *
 ...
 * ------------	-----------	--------------------------------------------
 * K Harrell	01/14/2012	Created
 * 							defect 11214 Ver 6.10.0 
 * ---------------------------------------------------------------------
 */

/** 
 * Frame to Renew Permanent Placards in Renewal Window
 * 
 * @version	6.10.0		02/05/2012 
 * @author	Kathy Harrell 
 * @since				01/12/2012	16:44:23 
 */
public class FrmRenewDisabledPlacardMRG028 
...
private final static String ERRMSG_DATA_MISS =
	"Data missing for IsNextVCMRG028";
private final static String ERRMSG_ERROR = "ERROR";
private final static String FRM_TITLE =
	"Renew Disabled Placard      MRG028";
private final static String RENEW_MSG =
	"This record will be marked as deleted. "
		+ "New Inventory will be issued with ";  

/**
 * 
 * FrmRenewDisabledPlacardMRG028 constructor comment.
 */
public FrmRenewDisabledPlacardMRG028()
{
	super();
	initialize();
}
 ...
 */
public FrmRenewDisabledPlacardMRG028(Dialog aaOwner)
{
	super(aaOwner);
	initialize();
}
 ...
 * @param aaOwner Frame
 */
public FrmRenewDisabledPlacardMRG028(Frame aaOwner)
{
	super(aaOwner);
	initialize();
}
...
public void actionPerformed(ActionEvent aaAE)
{
	...
	try
	{
		...
		{
			String lsDate = RTSDate.getMonthName(caDPCustData.getRTSExpMo()-1)+", "+caDPCustData.getRTSExpYr()+ " expiration. "; 
...
private ButtonPanel getButtonPanel1()
{
	if (ivjButtonPanel1 == null)
	{
		try
		{
			...
			ivjButtonPanel1.setBounds(145, 266, 216, 36);
...
public void setData(Object aaData)
{
	if (aaData != null)
	{
		...
		else if (aaData instanceof DisabledPlacardCustomerData)
		{
			...
			// "REN" + AcctItmCd = TransCd for Renew  
			...
			caDPCustData.setRTSExpYr(liYear +4);
...
private void setDataToDataObject(DisabledPlacardCustomerData aaDPCustData)
{
	...
	laAddDPData.setRTSExpYr(laAddDPData.getRTSExpYr() +4); 
