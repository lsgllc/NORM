 ...
 */
/**
 * The View Controller for the ACC023 screen.  It handles screen
 * navigation and controls the visibility of its frame.
 *
 * @version	5.2.3		07/26/2005 
 * @author	Michael Abernethy
 * <br>Creation Date:	07/03/2001 08:32:41
 */
public class VCPaymentSummaryACC023 extends AbstractViewController
{
	/**
	 * Creates a VCPaymentSummaryACC023.
	 */
	public VCPaymentSummaryACC023()
	{
		super();
	}
	/**
		...
		Object aaData)
	{
		if (getFrame() == null)
		{
			...
			{
				setFrame(new FrmPaymentSummaryACC023(laDialog));
			}
		}
