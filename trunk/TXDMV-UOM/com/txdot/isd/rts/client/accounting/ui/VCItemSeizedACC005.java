 ...
 */
/**
 * The View Controller for the ACC005 screen.  It handles 
 * screen navigation and controls the visibility of its frame.
 *
 * @version	5.2.3		07/26/2005 
 * @author	Michael Abernethy
 * <br>Creation Date:	07/03/2001 08:30:16 
 */
public class VCItemSeizedACC005 extends AbstractViewController
{
	/**
	 * Creates a VCItemSeizedACC005.
	 */
	public VCItemSeizedACC005()
	{
		super();
	}
	/**
	...
	/**
	 * Controls the screen flow from ACC005.  It passes the data to the 
	 * RTSMediator.
	 * 
	 * @param aiCommand	int 
	 * @param aaData 	Object
			...
			case ENTER :
				{
					...
					try
					{
						getMediator().processData(
							getModuleName(),
							AccountingConstant.ITEM_SEIZED,
							aaData);
					}
		...
		Object aaData)
	{
		if (getFrame() == null)
		{
			...
			{
				setFrame(
					new FrmItemSeizedACC005(
						getMediator().getDesktop()));
			}
			else
			{
				setFrame(new FrmItemSeizedACC005(laDialog));
			}
		}
