 ...
 * <br>Creation Date:	07/03/2001 08:18:21
 */

public class VCFundsDetailsACC024 extends AbstractViewController
{
	/**
	 * Creates a VCFundsDetailsACC024.
	 */
	public VCFundsDetailsACC024()
	{
		super();
	}
	/**
	...
	/**
	 * Controls the screen flow from ACC024.  It passes the data to the 
	 * RTSMediator.
	 * 
	 * @param aiCommand	int 
	 * @param aaData 	Object
		...
		Object aaData)
	{
		if (getFrame() == null)
		{
			...
			{
				setFrame(new FrmFundsDetailsACC024(laDialog));
			}
		}
