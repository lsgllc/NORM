...
/*
 *
 * VCRegistrationRefundREG004.java
 *
...
/**
 * VC used to capture the registration refund amount in status change.
 *
...
public class VCRegistrationRefundREG004
	extends com.txdot.isd.rts.client.general.ui.AbstractViewController
{
	/**
	 * VCStolenSRSTTL037 constructor comment.
	 */
	public VCRegistrationRefundREG004()
	{
		super();
	}
	/**
	...
	public void handleError(
		com.txdot.isd.rts.services.exception.RTSException e)
	{
		// Empty block of code
	}
	/**
	...
	public void processData(int aiCommand, java.lang.Object aaData)
	{
		switch (aiCommand)
		{
			case ENTER :
			{
				...
				CompleteTitleTransaction ttlTrans =
				...
				{
					laCompTransData =
						ttlTrans.doCompleteTransaction();
				}
		...
		Object aaData)
	{
		if (getFrame() == null)
		{
			...
			if (laRTSDBox != null)
			{
				setFrame(new FrmRegistrationRefundREG004(laRTSDBox));
			}
			else
			{
				setFrame(new FrmRegistrationRefundREG004(
