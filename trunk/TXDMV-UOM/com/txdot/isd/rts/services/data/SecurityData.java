 ...
 * ------------	-----------	--------------------------------------------
 * K. Harrell   11/20/2001  Added Password2- Password5
 * K. Harrell   01/09/2002  Removed PltToOwnrAccs, DelPltToOwnrAccs, 
 * 							RejctnAccs,FundsAckAccs
 *                          Added ItrntRenwlAccs, RegnlColltnAccs
 * K.  Harrell  04/30/2002  Added CrdtCardFeeAccs
 * MAbs			08/26/2002	PCR 41
 * MAbs			09/17/2002	PCR 41 Integration
 * Ray Rowehl	09/22/2003	Add ADUserId Field and handling
 *							add csAdUserId, getAdUserId(), setAdUserId
 *							add cbResetPassword, getResetPassword, 
 *							setResetPassword
 ...
 *							defect 6445 Ver 5.1.6
 * Ray Rowehl	01/14/2004	Add flag to determine if there are Active
 *							Directory Updates.
 *							add cbJniUpdate, getJniUpdate(), 
 *							setJniUpdate()
 *							defect 6445 Ver 5.1.6
 ...
 * 							Ver 5.2.0
 * K Harrell	04/02/2004	Remove csPassword,csPassword2-4,
 * 							ciPasswordExpDate,ciQuickCntrAccs,
 *							ciQuickCntrRptAccs 
 *							delete associated get/set methods
 *							defect 6995
 * Ray Rowehl	04/15/2004	add UserProvidedUserName to track if the
 *							UserName was provided.
 *							add cbUserProvidedUserName, 
 *							isUserProvidedUserName(),
 *							setUserProvidedUserName()
 ...
 * K Harrell	09/25/2006	Changes for Exempts
 ...
 * Min Wang		08/03/2009	add ciPrivateLawEnfVehAccs,
 ...
 */
/**
 * This Data class contains attributes and getter/setter methods 
 * for SecurityData.
 * 
...
{
	protected boolean cbJniUpdate = false;
	protected boolean cbResetPassword = false;

	protected boolean cbUserProvidedUserName = false;
	...
	private final static long serialVersionUID = -1432022323246764385L;
	...
	/**
	 * Returns the value of CrdtCardFeeAcccs
	 * @return  int 
	 */
	...
	/**
	 * Returns the value of cbJniUpdate
	 * @return  boolean 
	 */
	public final boolean getJniUpdate()
	{
		return cbJniUpdate;
	}
	/**
	...
	/**
	 * Returns the value of ReprntStkrAccs
	 * PCR 34
	 * @return int
	 */
	...
	/**
	* Returns the value of cbResetPassword
	* @return  boolean 
	*/
	public final boolean getResetPassword()
	{
		return cbResetPassword;
	}
	/**
	...
	/**
	 * Returns the value of cbUserProvidedUserName
	 * @return  boolean 
	 */
	public final boolean isUserProvidedUserName()
	{
		return cbUserProvidedUserName;
	}
	// end defect 10717
	/**
	 ...
	 * @param aiChngTimestmp   RTSDate 
	 */
	public final void setChngTimestmp(RTSDate aiChngTimestmp)
	{
		caChngTimestmp = aiChngTimestmp;
	}
	/**
	...
	*/
	...
	/**
	 * This method sets the value of ItrntRenwlAccs
	...
	/**
	 * This method sets the value of cbJniUpdate.
	 * @param abJniUpdate   boolean 
	 */
	public final void setJniUpdate(boolean abJniUpdate)
	{
		cbJniUpdate = abJniUpdate;
	}
	/**
	...
	/**
	 * This method sets the value of RegnlColltnAccs
	...
	/**
	 * This method sets the value of ReprntStkrRptAccs
	 * PCR 34
	 * @param newReprntStkrAccs int
	 */
	...
	/**
	 * This method sets the value of cbResetPassword.
	 * @param aiResetPassword   boolean 
	 */
	public final void setResetPassword(boolean aiResetPassword)
	{
		cbResetPassword = aiResetPassword;
	}
	/**
	...
	/**
	 * This method sets the value of cbUserProvidedUserName.
	 * @param abUserProvidedUserName   boolean 
	 */
	public final void setUserProvidedUserName(boolean abUserProvidedUserName)
	{
		cbUserProvidedUserName = abUserProvidedUserName;
	}
	/**
