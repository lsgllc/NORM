 ...
 * B Woodson	01/31/2012	add SALV_INDI_OFFSET, SALV_INDI_LENGTH
 * 							modify SALVAGE_RECORD_LENGTH, 
 *  						 setMultipleSalvageDataFromMf()
 * 							defect 11251 Ver 6.10.0
 * B Woodson	02/09/2012	modify SALVAGE_RECORD_LENGTH setMultipleSalvageDataFromMf()
 * 							defect 11251 Ver 6.10.0
 * ---------------------------------------------------------------------
 */
...
public class MfbaSalvageT
{
	...
	//defect 11251
	private static final int SALV_INDI_OFFSET = 37;
	private static final int SALV_INDI_LENGTH = 1;

	private final static int SALVAGE_RECORD_LENGTH = 38;
	//end defect 11251
