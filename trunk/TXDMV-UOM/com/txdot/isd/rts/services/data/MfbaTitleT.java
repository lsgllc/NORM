 ...
 * 							add ETTL_PRNT_DATE_OFFSET,
 *							 ETTL_PRNT_DATE_LENGTH 
 * 							modify MULTIPLE_REG_INDI_OFFSET,
 * 							  setTitleDataFromMf()
 ...
 * 							add SURVSHP_RIGHTS_NAME1_OFFSET, SURVSHP_RIGHTS_NAME1_LENGTH, 
 * 							 SURVSHP_RIGHTS_NAME2_OFFSET, SURVSHP_RIGHTS_NAME2_LENGTH,
 * 							 ADDL_SURVIVOR_INDI_OFFSET, ADDL_SURVIVOR_INDI_LENGTH, 
 * 							 EXPORT_INDI_OFFSET, EXPORT_INDI_LENGTH, 
 * 							 SALV_INDI_OFFSET, SALV_INDI_LENGTH
 * 							modify setTitleDataFromMf(), MULTIPLE_REG_INDI_OFFSET
 * 							defect 11251 Ver 6.10.0
 *  B Woodson	01/31/2012	modify MULTIPLE_REG_INDI_OFFSET, setTitleDataFromMf()
 * 							remove SALV_INDI_OFFSET, SALV_INDI_LENGTH
 * 							defect 11251 Ver 6.10.0
 * ---------------------------------------------------------------------
 */
...
public class MfbaTitleT
{
	...
	// defect 11045
	private static final int ETTL_PRNT_DATE_OFFSET = 1694;
	private static final int ETTL_PRNT_DATE_LENGTH = 8;
	public static final int MULTIPLE_REG_INDI_OFFSET = 1764;
	// end defect 11045
	private static final int MULTIPLE_REG_INDI_LENGTH = 1;
	
	//defect 11251
	private static final int SURVSHP_RIGHTS_NAME1_OFFSET = 1702;
	private static final int SURVSHP_RIGHTS_NAME1_LENGTH = 30;
	private static final int SURVSHP_RIGHTS_NAME2_OFFSET = 1732;
	private static final int SURVSHP_RIGHTS_NAME2_LENGTH = 30;
	private static final int ADDL_SURVIVOR_INDI_OFFSET = 1762;
	private static final int ADDL_SURVIVOR_INDI_LENGTH = 1;
	private static final int EXPORT_INDI_OFFSET = 1763;
	private static final int EXPORT_INDI_LENGTH = 1;
	//end defect 11251
	...
	public TitleData setTitleDataFromMf(String asMfResponse)
	{
			...
			&& (asMfResponse != null))
		{
			...
			// defect 11045 
			laTitleData.setETtlPrntDate(
					Integer
						.valueOf(
							laMFAccess.getStringFromZonedDecimal(
								asMfResponse.substring(
									ETTL_PRNT_DATE_OFFSET,
									ETTL_PRNT_DATE_OFFSET
										+ ETTL_PRNT_DATE_LENGTH)))
						.intValue());
			// end defect 11045 
			...
			//defect 11251
			laTitleData.setSurvShpRightsName1(
					laMFAccess.trimMfString(
						asMfResponse.substring(
								SURVSHP_RIGHTS_NAME1_OFFSET,
								SURVSHP_RIGHTS_NAME1_OFFSET
								+ SURVSHP_RIGHTS_NAME1_LENGTH)));
			laTitleData.setSurvShpRightsName2(
					laMFAccess.trimMfString(
						asMfResponse.substring(
								SURVSHP_RIGHTS_NAME2_OFFSET,
								SURVSHP_RIGHTS_NAME2_OFFSET
								+ SURVSHP_RIGHTS_NAME2_LENGTH)));
			laTitleData.setAddlSurvivorIndi(
					Integer
						.valueOf(
							laMFAccess.getStringFromZonedDecimal(
								asMfResponse.substring(
										ADDL_SURVIVOR_INDI_OFFSET,
										ADDL_SURVIVOR_INDI_OFFSET
										+ ADDL_SURVIVOR_INDI_LENGTH)))
						.intValue());
			laTitleData.setExportIndi(
					Integer
						.valueOf(
							laMFAccess.getStringFromZonedDecimal(
								asMfResponse.substring(
