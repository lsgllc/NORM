...
public class RTSFees_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public RTSFees_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        RTSFees bean = (RTSFees) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_3_35;
          propValue = new Double(bean.getItemAmt());
          context.serialize(propQName, null, 
              propValue, 
              QName_1_31,
              true,null);
          propQName = QName_3_36;
          propValue = bean.getFeesAcctCdDesc();
