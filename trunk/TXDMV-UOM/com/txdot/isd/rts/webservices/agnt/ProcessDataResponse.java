...
public class ProcessDataResponse  implements java.io.Serializable {
    private com.txdot.isd.rts.webservices.agnt.data.RtsWebAgntResponse[] processDataReturn;

    public ProcessDataResponse() {
    }

    public com.txdot.isd.rts.webservices.agnt.data.RtsWebAgntResponse[] getProcessDataReturn() {
        return processDataReturn;
    }

    public void setProcessDataReturn(com.txdot.isd.rts.webservices.agnt.data.RtsWebAgntResponse[] processDataReturn) {
        this.processDataReturn = processDataReturn;
    }

    public com.txdot.isd.rts.webservices.agnt.data.RtsWebAgntResponse getProcessDataReturn(int i) {
        return processDataReturn[i];
    }

    public void setProcessDataReturn(int i, com.txdot.isd.rts.webservices.agnt.data.RtsWebAgntResponse value) {
