/**
 * RtsBatchDetailRequest_Helper.java
 *
...
public class RtsBatchDetailRequest_Helper {
    // Type metadata
    private static com.ibm.ws.webservices.engine.description.TypeDesc typeDesc =
        new com.ibm.ws.webservices.engine.description.TypeDesc(RtsBatchDetailRequest.class);
    ...
    static {
        ...
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://data.bat.webservices.rts.isd.txdot.com", "savReqId"));
        field.setXmlType(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://www.w3.org/2001/XMLSchema", "int"));
        typeDesc.addFieldDesc(field);
        field = new com.ibm.ws.webservices.engine.description.ElementDesc();
        ...
        field.setXmlName(com.ibm.ws.webservices.engine.utils.QNameTable.createQName("http://data.bat.webservices.rts.isd.txdot.com", "regPltNo"));
    ...
    public static com.ibm.ws.webservices.engine.encoding.Deserializer getDeserializer(
           ...
           javax.xml.namespace.QName xmlType) {
        return 
          new RtsBatchDetailRequest_Deser(
            javaType, xmlType, typeDesc);
    };
