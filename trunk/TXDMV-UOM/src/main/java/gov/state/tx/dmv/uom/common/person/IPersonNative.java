...
public interface IPersonNative<T extends PERSON_TYPE> extends INormPersistable {
    ...
    void setLastName(String lastName)throws UOMSpecifiedException, StrangeAndWonderfulException;

    String getSalutation() throws UOMSpecifiedException, StrangeAndWonderfulException, NormNotFoundException;
    void setSalutation(String salutation)throws UOMSpecifiedException, StrangeAndWonderfulException;

    String getNameSuffix() throws UOMSpecifiedException, StrangeAndWonderfulException, NormNotFoundException;
    void setNameSuffix(String middleName)throws UOMSpecifiedException, StrangeAndWonderfulException;
